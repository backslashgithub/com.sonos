...
class Driver extends events.EventEmitter {
	...
	_onInit(devicesData, callback) {
		...
		this._searchResults = {
			'B8-E9-37-2C-BF-12:2': {
				serialNum: 'B8-E9-37-2C-BF-12:2',
				deviceType: 'urn:schemas-upnp-org:device:ZonePlayer:1',
				UDN: 'uuid:RINCON_B8E9372CBF1201400',
				friendlyName: '192.168.1.18 - Sonos PLAY:5',
				roomName: 'Play:5',
				modelNumber: 'S5',
				displayName: 'PLAY:5',
				host: '192.168.1.18',
			...
			'B8-E9-37-82-EB-20:A': {
				serialNum: 'B8-E9-37-82-EB-20:A',
				deviceType: 'urn:schemas-upnp-org:device:ZonePlayer:1',
				UDN: 'uuid:RINCON_B8E93782EB2001400',
				friendlyName: '192.168.1.30 - Sonos PLAY:1',
				manufacturer: 'Sonos, Inc.',
				roomName: 'Play:1 Links',
			...
			'5C-AA-FD-7C-2E-FC:C': {
				serialNum: '5C-AA-FD-7C-2E-FC:C',
				satGainOffset: '6.000',
				deviceType: 'urn:schemas-upnp-org:device:ZonePlayer:1',
				variant: '1',
				legacyCompatibleVersion: '25.0-00000',
				UDN: 'uuid:RINCON_5CAAFD7C2EFC01400',
				flash: '64',
				friendlyName: '192.168.1.37 - Sonos PLAY:1',
				manufacturer: 'Sonos, Inc.',
				feature2: '0x00403332',
				roomName: 'Play:1 Rechts',
