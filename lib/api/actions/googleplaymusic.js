...
async function googlePlayMusic(player, values) {
	...
	const encodedGPMUri = encodeURIComponent(spotifyUri);
	...
	const metadata = getGooglePlayMusicMetadata(encodedGPMUri, player.system.getServiceType('Google Play Music'));
