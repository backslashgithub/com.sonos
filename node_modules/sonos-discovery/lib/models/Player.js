        ...
        sax.on('tag:item', (item) => {
          returnResult.items.push({
            ...
            metadata: item['r:resmd'],
	          protocolInfo: item.res ? item.res.$attrs.protocolinfo || item.res.protocolinfo : undefined,
	          duration: item.res ? parseTime((item.res.$attrs || item.res).duration) : undefined,
	          id: item.$attrs ? item.$attrs.id : undefined,
          });
        });
